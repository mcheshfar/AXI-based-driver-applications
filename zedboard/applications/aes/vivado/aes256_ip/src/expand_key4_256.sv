...
always_comb
	if(!in_key_empty && !out_key_full)
		...
		out_key_din[16`ith] <= in_key_dout[16`ith] ^ sub_byte(in_key_dout[12`ith]);
		out_key_din[17`ith] <= in_key_dout[17`ith] ^ sub_byte(in_key_dout[13`ith]);
		out_key_din[18`ith] <= in_key_dout[18`ith] ^ sub_byte(in_key_dout[14`ith]);
		out_key_din[19`ith] <= in_key_dout[19`ith] ^ sub_byte(in_key_dout[15`ith]);
