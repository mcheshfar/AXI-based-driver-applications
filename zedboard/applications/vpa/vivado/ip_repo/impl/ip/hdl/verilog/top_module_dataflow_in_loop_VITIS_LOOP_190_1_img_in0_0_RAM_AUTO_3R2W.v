...
`timescale 1ns/1ps
module top_module_dataflow_in_loop_VITIS_LOOP_190_1_img_in0_0_RAM_AUTO_3R2W
#(parameter
    DataWidth    = 8,
    AddressRange = 22,
    AddressWidth = 5,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        top_module_dataflow_in_loop_VITIS_LOOP_190_1_img_in0_0_RAM_AUTO_3R2W_memcore top_module_dataflow_in_loop_VITIS_LOOP_190_1_img_in0_0_RAM_AUTO_3R2W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),
